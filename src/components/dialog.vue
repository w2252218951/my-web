            ...
            <div class="dialog-box">
                <div class="dialog-wrapper" :style="dialogBox">
                    <div class="dialog-header" :class="{'dialog-title':title }">
                        {{title}}
                        <i class="icon-font  dialog-close icon-close" @click="close"></i>
                    </div>
                    <div :style="dialogContent" :height="0">
                        <slot></slot> <!--在引用组件中添加内容  就可以在这里显示-->
                    </div>
                    <div class="dialog-footer" v-if="cancelButtonShow || confirmButtonShow">
                        <!-- :show 是props 的绑定方法   可写论文 -->
